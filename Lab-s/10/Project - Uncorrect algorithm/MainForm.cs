...
public partial class MainForm : Form
{
    ...
    {
        _filtersPatterns.Add("������������", Pattern_Identity);
        _filtersPatterns.Add("������", Pattern_Ridge);
        _filtersPatterns.Add("����������� ������", Pattern_EdgeDetection);
        _filtersPatterns.Add("���������� ��������", Pattern_Sharpen);
        _filtersPatterns.Add("�������� ����", Pattern_BoxBlur);
        _filtersPatterns.Add("�������� �� ������ 3�3", Pattern_GaussianBlur_3x3);
        _filtersPatterns.Add("�������� �� ������ 5�5", Pattern_GaussianBlur_5x5);
        _filtersPatterns.Add("������ �������� �� ������ 5�5", Pattern_SecondGaussianBlur_5x5);
        _filtersPatterns.Add("������", Pattern_Convolution);
        _filtersPatterns.Add("��������� ��������", Pattern_DefinitionIncrease);
        _filtersPatterns.Add("�����������", Pattern_Neighborhood);

        _filtersPatterns.Add("����", () => { });
